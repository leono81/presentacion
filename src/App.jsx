        ...
        <div className={`w-full max-w-7xl transition-all duration-1000 transform ${scrollProgress > 0.77 && scrollProgress < 0.88 ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start text-white text-white text-white text-white">
            <div className="space-y-8 md:space-y-12 text-white">
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-white leading-none">Cerebro Digital<br /></h2>
              <div className="space-y-6 pt-4 text-white"><div className="p-8 bg-cyan-500/5 border border-cyan-500/20 rounded-[2.5rem] flex flex-col md:flex-row items-center gap-6 group shadow-2xl text-white"><div className="p-5 bg-cyan-400 rounded-2xl shadow-[0_0_30px_#22d3ee]"><Clock className="text-slate-950 group-hover:scale-110 transition-transform text-white" size={48} /></div><div className="text-center md:text-left text-white"><h4 className="font-black text-2xl mb-1 uppercase text-white text-white text-white">Implementación</h4><p className="text-lg text-slate-400 italic font-light">De 3 semanas a 1 mes de implementación.</p></div></div></div>
            </div>
            <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-[3rem] p-8 md:p-12 shadow-[0_40px_100px_rgba(0,0,0,0.4)] space-y-10 text-white text-white">
              ...
              <div className="pt-10 border-t border-slate-700 flex flex-col md:flex-row justify-between items-center md:items-end gap-8 text-white"><div className="text-center md:text-left text-white text-white text-white"><p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-1 text-white text-white">Presupuesto de Fase</p><div className="flex items-baseline gap-2 text-white"><span className="text-2xl font-bold text-cyan-500/30">$</span><p className="text-5xl md:text-6xl font-black text-white leading-none text-white text-white">1.800.000</p><span className="text-base text-slate-400 font-normal text-white">ARS</span></div><div className="inline-flex items-center gap-3 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-xl text-[11px] font-bold text-green-400 uppercase tracking-widest text-white mt-4"><Zap size={14} className="fill-green-400 text-white" /> Mantenimiento del mes Bonificado</div></div></div>
            </div>
          </div>
        </div>
      </section>
